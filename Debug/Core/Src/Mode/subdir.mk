...
CPP_SRCS += \
../Core/Src/Mode/BaseMode.cpp 

OBJS += \
./Core/Src/Mode/BaseMode.o 

CPP_DEPS += \
./Core/Src/Mode/BaseMode.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Mode/%.o Core/Src/Mode/%.su Core/Src/Mode/%.cyclo: ../Core/Src/Mode/%.cpp Core/Src/Mode/subdir.mk
...
clean: clean-Core-2f-Src-2f-Mode

clean-Core-2f-Src-2f-Mode:
	-$(RM) ./Core/Src/Mode/BaseMode.cyclo ./Core/Src/Mode/BaseMode.d ./Core/Src/Mode/BaseMode.o ./Core/Src/Mode/BaseMode.su

.PHONY: clean-Core-2f-Src-2f-Mode
